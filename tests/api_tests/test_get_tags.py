...
class TestGetTags:
    ...
    def test_get_all_user_tags_returns_expected_tags(self, get_header_auth, api_url):
    ...
    def test_get_user_tag_by_id_returns_correct_tag(self, get_header_auth, api_url):
    ...
    def test_get_user_tag_by_invalid_id_returns_not_found(self, api_url, get_header_auth):
